    ...
    def action_make_stock_request(self):
        ...
        for move in self.mapped("move_raw_ids"):
            ...
            if move_key in product_product_uom_id.keys():
                product_product_uom_id[move_key].update({'quantity':product_product_uom_id[move_key]['quantity']+move.product_uom_qty,
                                               'quantity_to_request':product_product_uom_id[move_key]['quantity_to_request']+move.product_uom_qty})
            else:
